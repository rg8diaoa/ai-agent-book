...
> 📚 **صدر الكتاب الشقيق _فهم بنية الذكاء الاصطناعي التحتية بعمق: التحليل الكمي وتصميم الأنظمة_ بمصدر مفتوح** — [github.com/bojieli/ai-infra-book](https://github.com/bojieli/ai-infra-book)
>
