...
> 核心理念：学习 agent 开发要有自己的思想，课程实验本身必须本人完成；**但使用 agent 本身也是一种能力**，不涉及课程实验本身的准备工作可委托 AI 代办。
...
| 学习笔记 / 心得（`learn/chN/notes/**`） | **本人撰写**；AI 只做格式建议，不代写观点 | Task0学习笔记（三件套：学习笔记/操作手册/坑位全盘查） |
